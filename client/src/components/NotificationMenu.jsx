...
const NotificationMenu = ({ onClose, onMarkRead }) => {
    const { user } = useAuth();
    ...
    useEffect(() => {
        const fetchNotifications = async () => {
            try {
                ...
                setNotifications([...alertNotifs, ...reqNotifs, ...msgNotifs].sort((a, b) => new Date(b.time) - new Date(a.time)));
    ...
    return (
        <div className="absolute top-12 right-0 w-80 bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden z-50 animate-fade-in origin-top-right">
            ...
            <div className="max-h-80 overflow-y-auto">
                {loading ? (
                    ...
                    notifications.map((n) => (
                        <div key={n.id} className="px-4 py-3 border-b hover:bg-gray-50 transition flex items-center gap-3">
