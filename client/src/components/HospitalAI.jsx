...
import { DashboardCard, Input, LoadingSpinner, ProgressBar } from './Common';
...
export const AmbulanceETAPredictor = ({ hospitalName }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await fetch(`${API_BASE_URL}/api/hosp/predict_eta`, {
                method: 'POST',
...
export const BedForecastPredictor = ({ hospitalId }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await fetch(`${API_BASE_URL}/api/hosp/predict_bed_forecast`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
...
export const StaffAllocator = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await fetch(`${API_BASE_URL}/api/hosp/predict_staff_allocation`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
...
export const HospitalDiseaseForecast = ({ hospitalId }) => {
    ...
    const fetchForecast = async (disease = selectedDisease, days = daysForecast) => {
        ...
        setError(null);
        try {
            const res = await fetch(`${API_BASE_URL}/api/hosp/predict_disease_forecast`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
